...
class SlideLayout(str, Enum):
    ...
    TITLE_AND_CONTENT = "title_and_content"  # Standard layout with title and content area for text or media
    SECTION_HEADER = "section_header"  # Section break slide with title for transitioning between topics
    TWO_CONTENT = (
        "two_content"  # Two side-by-side content areas with bullet points or text
    )
    COMPARISON = (
        "comparison"  # Side-by-side comparison with titles for each content area
    )
    ...
    CONTENT_WITH_CAPTION = (
        "content_with_caption"  # Content area with accompanying caption text
    )
    ...
    def get_descriptions(cls) -> dict[str, str]:
        ...
        return {
            ...
            cls.SECTION_HEADER.value: "Section break slide with title for transitioning between topics",
            ...
            cls.TITLE_ONLY.value: "Clean slide with only a centered title",
            cls.BLANK.value: "Empty slide with no predefined content areas",
            cls.CONTENT_WITH_CAPTION.value: "Content area with accompanying caption text",
